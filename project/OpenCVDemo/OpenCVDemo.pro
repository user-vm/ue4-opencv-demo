...
unrealRootPath=/home/v/2022/UnrealEngine
OpenCVDemoRootPath=/home/v/2022/UnrealProjects/ue4-opencv-demo/project/OpenCVDemo

gameProjectFile=/home/v/2022/UnrealProjects/ue4-opencv-demo/project/OpenCVDemo/OpenCVDemo.uproject
...
include(OpenCVDemoSource.pri)
include(OpenCVDemoHeader.pri)
include(OpenCVDemoConfig.pri)
include(OpenCVDemoIncludes.pri)
include(OpenCVDemoDefines.pri)
...
OpenCVDemo-Linux-Debug.commands = $$build OpenCVDemo Linux Debug  -project="\"$$gameProjectFile\"" $$args
OpenCVDemo-Linux-DebugGame.commands = $$build OpenCVDemo Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
OpenCVDemo-Linux-Shipping.commands = $$build OpenCVDemo Linux Shipping  -project="\"$$gameProjectFile\"" $$args
OpenCVDemo-Linux-Test.commands = $$build OpenCVDemo Linux Test  -project="\"$$gameProjectFile\"" $$args
OpenCVDemo.commands = $$build OpenCVDemo Linux Development  -project="\"$$gameProjectFile\"" $$args

OpenCVDemoEditor-Linux-Debug.commands = $$build OpenCVDemoEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
OpenCVDemoEditor-Linux-DebugGame.commands = $$build OpenCVDemoEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
OpenCVDemoEditor-Linux-Shipping.commands = $$build OpenCVDemoEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
OpenCVDemoEditor-Linux-Test.commands = $$build OpenCVDemoEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
OpenCVDemoEditor.commands = $$build OpenCVDemoEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	UE4Server \
	OpenCVDemo-Linux-Debug \
	OpenCVDemo-Linux-DebugGame \
	OpenCVDemo-Linux-Shipping \
	OpenCVDemo-Linux-Test \
	OpenCVDemo \
	OpenCVDemoEditor-Linux-Debug \
	OpenCVDemoEditor-Linux-DebugGame \
	OpenCVDemoEditor-Linux-Shipping \
	OpenCVDemoEditor-Linux-Test \
	OpenCVDemoEditor \
